                        ...
                        <tr>
                          <th class="small-12 large-12 columns first last">
                            <table>
                              <tr>
                                <th>
                                  <h1>Gracias por contactar a nuestro equipo de soporte.</h1>
                                  <p>Se ha abierto un ticket de soporte para su solicitud. Nuestro equipo técnico lo contactará a la brevedad. Los detalles de su ticket se muestran a continuación.</p>
                                  <table class="spacer">
                                    <tbody>
                                      <tr>
                                        <td height="16px" style="font-size:16px;line-height:16px;">&#xA0;</td>
