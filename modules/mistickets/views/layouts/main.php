										...
										<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left">
											...
											<ul class="m-menu__subnav">
												<li class="m-menu__item "  aria-haspopup="true">
													<a  href="header/actions.html" class="m-menu__link " data-toggle="modal" data-target="#m_modal_5">
...
<!-- 										<li id="m_quick_sidebar_toggle" class="m-nav__item">
		...
		<!-- begin::Body -->
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
				...
				<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark " style="min-height: 1600px;">
					<!-- BEGIN: Aside Menu -->
	<div 
		id="m_ver_menu" 
						...
						<div class="modal fade" id="m_modal_5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog modal-sm" role="document">
								<div class="modal-content">
									<form action="<?php echo Url::base('http').'/index.php?r=dashboard/default/createnote';  ?>" id="create_note" method="post" role="form" class="ajaxform">
									...
									<div class="modal-body">
											...
											<div class="form-group">
												<label for="nota_titulo" class="form-control-label">
													Titulo:
												</label>
												<input type="text" class="form-control" id="nota_titulo" required="required" name="nota_titulo">
											</div>
											<div class="form-group">
												<label for="nota" class="form-control-label">
													Nota:
												</label>
												<textarea class="form-control" id="nota" required="required" name="nota"></textarea>
											</div>
           					...
           					{   
           						...
           						template:function(e){
           							var t={
           							    ...
           							    return'<span class="m-badge '+t[e.Status].class+' m-badge--wide">'+t[e.Status].title+"</span>"}},{field:"Type",title:"Type",template:function(e){var t={1:{title:"Online",state:"danger"},2:{title:"Retail",state:"primary"},3:{title:"Direct",state:"accent"}};
           							    return'<span class="m-badge m-badge--'+t[e.Type].state+' m-badge--dot"></span>&nbsp;<span class="m--font-bold m--font-'+t[e.Type].state+'">'+t[e.Type].title+"</span>"}}]}),$("#m_form_status").on("change",function(){e.search($(this).val().toLowerCase(),"Status")}),
